...
function sw(a, r) {
  if (
    a === "__proto__" ||
    (a === "constructor" && r && typeof r == "object" && "prototype" in r)
  ) {
    nw(a);
    return;
  }
...
function hw(a) {
  return typeof a != "string" || !a.startsWith(gc)
    ? a
    : (Xl(), Buffer.from(a.slice(gc.length), "base64"));
}
function ur(a) {
  return a
    ? a
...
function dw(a = {}) {
  const r = {
    ...
    i = (v) => {
      ...
      return { base: "", relativeKey: v, driver: r.mounts[""] };
    },
    n = (v, I) =>
      r.mountpoints
        .filter((R) => R.startsWith(v) || (I && v.startsWith(R)))
        .map((R) => ({
    ...
    g = (v, I, R) => {
      const A = new Map(),
        z = (T) => {
          ...
          return (
            F ||
              ((F = { driver: T.driver, base: T.base, items: [] }),
              A.set(T.base, F)),
            F
          );
        };
      ...
      return Promise.all([...A.values()].map((T) => R(T))).then((T) =>
        T.flat()
      );
    },
    _ = {
        ...
        return g(v, I, (R) =>
          R.driver.getItems
            ? Ut(
                ...
                A.map((z) => ({ key: lw(R.base, z.key), value: ao(z.value) }))
              )
            : Promise.all(
                R.items.map((A) =>
                  Ut(R.driver.getItem, A.relativeKey, A.options).then((z) => ({
                    key: A.key,
                    value: ao(z),
                  }))
                )
      ...
      async setItem(v, I, R = {}) {
        ...
        z.setItem &&
          (await Ut(z.setItem, A, go(I), R), z.watch || o("update", v));
      },
      async setItems(v, I) {
        await g(v, I, async (R) => {
          R.driver.setItems &&
            ...
            R.driver.setItem &&
              (await Promise.all(
                R.items.map((A) =>
                  Ut(R.driver.setItem, A.relativeKey, go(A.value), A.options)
                )
              ));
        });
      },
      ...
      async removeItem(v, I = {}) {
        typeof I == "boolean" && (I = { removeMeta: I }), (v = ur(v));
        const { relativeKey: R, driver: A } = i(v);
        A.removeItem &&
          (await Ut(A.removeItem, R, I),
          (I.removeMeta || I.removeMata) &&
            (await Ut(A.removeItem, R + "$", I)),
          A.watch || o("remove", v));
      },
      async getMeta(v, I = {}) {
        typeof I == "boolean" && (I = { nativeOnly: I }), (v = ur(v));
        const { relativeKey: R, driver: A } = i(v),
          z = Object.create(null);
        if (
          (A.getMeta && Object.assign(z, await Ut(A.getMeta, R, I)),
          !I.nativeOnly)
        ) {
      ...
      async getKeys(v, I = {}) {
        ...
        const z = [];
        for (const T of R) {
          const re = (await Ut(T.driver.getKeys, T.relativeBase, I))
            .map((he) => T.mountpoint + ur(he))
            .filter((he) => !A.some((le) => he.startsWith(le)));
          z.push(...re),
            (A = [
              T.mountpoint,
              ...A.filter((he) => !he.startsWith(T.mountpoint)),
            ]);
        }
        return v
          ? z.filter((T) => T.startsWith(v) && !T.endsWith("$"))
          : z.filter((T) => !T.endsWith("$"));
      },
      async clear(v, I = {}) {
        (v = co(v)),
          await Promise.all(
      ...
      async unmount(v, I = !0) {
        (v = co(v)),
          !(!v || !r.mounts[v]) &&
            (r.watching &&
              v in r.unwatch &&
              (r.unwatch[v](), delete r.unwatch[v]),
      ...
      getMounts(v = "", I = {}) {
        return (
          (v = ur(v)),
          n(v, I.parents).map((A) => ({ driver: A.driver, base: A.mountpoint }))
        );
      },
    };
  return _;
...
const _w = (a) =>
    JSON.stringify(a, (r, i) =>
      typeof i == "bigint" ? i.toString() + "n" : i
    ),
  bw = (a) => {
    const r =
        /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g,
      i = a.replace(r, '$1"$2n"$3');
    return JSON.parse(i, (n, o) =>
...
var Iw = (a = {}) => {
  ...
  let n;
  return (
    a.dbName && a.storeName && (n = Zl(a.dbName, a.storeName)),
    {
      name: Ew,
      options: a,
      async hasItem(o) {
...
let Sw = class {
  constructor() {
    this.indexedDb = dw({ driver: Iw({ dbName: xw, storeName: Pw }) });
  }
  async getKeys() {
...
function jw() {
  ...
  function r(i, n, o) {
    ...
    if (I === 0) return i;
    for (
      var R = "", A = 1 - p, z = -1, T = (i && i.length) || 0, F = 0;
      F < T;
...
function zw() {
    ...
    function k(B, G) {
      ...
      function Ie(It) {
        (this._childLevel = (It._childLevel | 0) + 1),
          ...
          Ke && ((this.serializers = Ke), (this._serialize = jr)),
      ...
      (H[W] = (function (ve) {
        return function () {
          ...
          if (
            (L.serialize &&
              !L.asObject &&
              _(Te, this._serialize, this.serializers, this._stdErrSerialize),
  ...
  function A(L) {
    const H = { type: L.constructor.name, msg: L.message, stack: L.stack };
    for (const W in L) H[W] === void 0 && (H[W] = L[W]);
    return H;
  }
  function z(L) {
    return typeof L.timestamp == "function"
      ? L.timestamp
      : L.timestamp === !1
      ? he
      : le;
...
function rf() {
  return (
    Yh ||
      ...
      (ki.PINO_LOGGER_DEFAULTS = { level: "info" }),
...
(function (a) {
  Object.defineProperty(a, "__esModule", { value: !0 }), (a.pino = void 0);
  const r = ws,
...
(function (a) {
  ...
  function o($) {
    ...
    if ($) for (let C = 0; C < $.length; C++) D[C] = $[C];
    return D;
  }
  ...
  function re($, D) {
    ...
    for (let E = 0; E < 2; E++) {
      ...
      for (let ge = 1; ge < 15; ge++)
        (C[ge] = u[ge] - 65535 - ((C[ge - 1] >> 16) & 1)), (C[ge - 1] &= 65535);
      C[15] = u[15] - 32767 - ((C[14] >> 16) & 1);
      const ee = (C[15] >> 16) & 1;
      (C[14] &= 65535), F(u, C, 1 - ee);
    }
    for (let E = 0; E < 16; E++)
      ($[2 * E] = u[E] & 255), ($[2 * E + 1] = u[E] >> 8);
  }
  function he($, D) {
    let C = 0;
  ...
  function X($) {
    ...
    return E.set($), E.set(C, 32), { publicKey: C, secretKey: E };
  }
  ...
  function B($, D) {
    ...
    for (C = 0, E = 0; E < 32; E++)
      (D[E] += C - (D[31] >> 4) * k[E]), (C = D[E] >> 8), (D[E] &= 255);
  ...
  function jr($, D, C) {
    ...
    const be = ge.digest();
    return (
      G(be), m(E, ee, be), x(ee, C.subarray(32)), ue(E, ee), Ue(u, E), !he(C, u)
    );
  }
  a.verify = jr;
  function Ie($) {
...
async function f_(a, r, i, n, o = se.fromMiliseconds(Date.now())) {
  const h = { alg: Zw, typ: e_ },
    p = af(n.publicKey),
    g = o + i,
    _ = { iss: p, sub: a, aud: r, iat: o, exp: g },
    v = h_({ header: h, payload: _ }),
    I = Sc.sign(n.secretKey, v);
  return l_({ header: h, payload: _, signature: I });
}
const p_ = "PARSE_ERROR",
  ...
  Qs = {
    [p_]: { code: -32700, message: "Parse error" },
    [d_]: { code: -32600, message: "Invalid Request" },
    [g_]: { code: -32601, message: "Method not found" },
    [y_]: { code: -32602, message: "Invalid params" },
    [cf]: { code: -32603, message: "Internal error" },
    [Oc]: { code: -32e3, message: "Server error" },
  },
  uf = Oc;
function m_(a) {
...
function hf(a, r, i) {
  return a.message.includes("getaddrinfo ENOTFOUND") ||
    ...
    ? new Error(`Unavailable ${i} RPC url at ${r}`)
    : a;
}
var lf = {},
  si = {},
...
function __() {
  ...
  function a() {
    return (
      (Mr === null || Mr === void 0 ? void 0 : Mr.crypto) ||
      (Mr === null || Mr === void 0 ? void 0 : Mr.msCrypto) ||
      {}
    );
  }
...
function vs(a, r, i) {
  return { id: i || Rc(), jsonrpc: "2.0", method: a, params: r };
}
function bo(a, r) {
  return { id: a, jsonrpc: "2.0", result: r };
}
function Eo(a, r, i) {
  return { id: a, jsonrpc: "2.0", error: E_(r, i) };
}
function E_(a, r) {
  return typeof a > "u"
    ? tl(cf)
    : (typeof a == "string" &&
        (a = Object.assign(Object.assign({}, tl(Oc)), { message: a })),
      typeof r < "u" && (a.data = r),
...
class ui extends P_ {
  ...
  async request(r, i) {
    return this.requestStrict(
      vs(r.method, r.params || [], r.id || ff().toString()),
      i
    );
  }
  ...
  onPayload(r) {
    this.events.emit("payload", r),
      Io(r)
        ...
        : this.events.emit("message", { type: r.method, data: r.params });
  }
  onClose(r) {
    r &&
      r.code === 3e3 &&
      this.events.emit(
        "error",
        new Error(
          `WebSocket connection closed abnormally with code: ${r.code} ${
            r.reason ? `(${r.reason})` : ""
          }`
        )
      ),
  ...
  async open(r = this.connection) {
    (this.connection === r && this.connection.connected) ||
      (this.connection.connected && this.close(),
      typeof r == "string" &&
        (await this.connection.open(r), (r = this.connection)),
      (this.connection = this.setConnection(r)),
  ...
  registerEventListeners() {
    this.hasRegisteredEventListeners ||
      (this.connection.on("payload", (r) => this.onPayload(r)),
...
let D_ = class {
  constructor(r) {
    if (
      ...
      throw new Error(
        `Provided URL is not compatible with WebSocket connection: ${r}`
      );
    this.url = r;
  }
  get connected() {
  ...
  emitError(r) {
    const i = this.parseError(
      new Error(
        (r == null ? void 0 : r.message) ||
          `WebSocket connection failed for host: ${ol(this.url)}`
      )
    );
...
(function (a, r) {
  ...
  function sn(y, P) {
    ...
    if (U instanceof vr) {
      var Q = U.__data__;
      if (!rt || Q.length < i - 1)
        return Q.push([y, P]), (this.size = ++U.size), this;
  ...
  function Ri(y, P) {
    for (var U = y.length; U--; ) if (yn(y[U][0], P)) return U;
    return -1;
  }
  function bs(y, P, U) {
    var Q = P(y);
  ...
  var ln = Vr
      ...
      : Fe,
    Ur = Ci;
  ((lt && Ur(new lt(new ArrayBuffer(1))) != Te) ||
    (rt && Ur(new rt()) != F) ||
    (ft && Ur(ft.resolve()) != fe) ||
    (pt && Ur(new pt()) != L) ||
    (ct && Ur(new ct()) != ie)) &&
...
function H_(a, r) {
  ...
  function R(T) {
    ...
    for (var F = 0, re = 0, he = 0, le = T.length; he !== le && T[he] === 0; )
      he++, F++;
    for (
      var fe = ((le - he) * I + 1) >>> 0, pe = new Uint8Array(fe);
      he !== le;

    ) {
      for (
        var de = T[he], L = 0, H = fe - 1;
        (de !== 0 || L < re) && H !== -1;
        H--, L++
      )
        (de += (256 * pe[H]) >>> 0),
  ...
  function A(T) {
    ...
    if (T[F] !== " ") {
      ...
      for (
        var le = ((T.length - F) * v + 1) >>> 0, fe = new Uint8Array(le);
        T[F];
  ...
  return { encode: R, decodeUnsafe: A, decode: z };
}
var k_ = H_,
  K_ = k_;
const gf = (a) => {
...
class G_ {
  constructor(r, i, n) {
    if (((this.name = r), (this.prefix = i), i.codePointAt(0) === void 0))
...
const xo = ({ name: a, prefix: r, encode: i, decode: n }) => new J_(a, r, i, n),
  en = ({ prefix: a, name: r, alphabet: i }) => {
    ...
    return xo({ prefix: a, name: r, encode: n, decode: (h) => gf(o(h)) });
  },
  Q_ = (a, r, i, n) => {
    const o = {};
  ...
  Y_ = (a, r, i) => {
    ...
    for (let _ = 0; _ < a.length; ++_)
      for (g = (g << 8) | a[_], p += 8; p > i; )
        (p -= i), (h += r[o & (g >> p)]);
    if ((p && (h += r[o & (g << (i - p))]), n))
      for (; (h.length * i) & 7; ) h += "=";
    return h;
  },
  Bt = ({ name: a, prefix: r, bitsPerChar: i, alphabet: n }) =>
    xo({
      prefix: r,
      name: a,
      encode(o) {
...
var Z_ = Object.freeze({ __proto__: null, identity: X_ });
const eb = Bt({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var tb = Object.freeze({ __proto__: null, base2: eb });
const rb = Bt({
  prefix: "7",
  name: "base8",
  alphabet: "01234567",
...
var ib = Object.freeze({ __proto__: null, base8: rb });
const sb = en({ prefix: "9", name: "base10", alphabet: "0123456789" });
var nb = Object.freeze({ __proto__: null, base10: sb });
const ob = Bt({
    prefix: "f",
    name: "base16",
...
var cb = Object.freeze({ __proto__: null, base16: ob, base16upper: ab });
const ub = Bt({
    prefix: "b",
    name: "base32",
...
var bb = Object.freeze({ __proto__: null, base36: wb, base36upper: _b });
const Eb = en({
    name: "base58btc",
    prefix: "z",
...
var xb = Object.freeze({ __proto__: null, base58btc: Eb, base58flickr: Ib });
const Pb = Bt({
    prefix: "m",
    name: "base64",
    alphabet:
...
const $b = xo({ prefix: "🚀", name: "base256emoji", encode: Nb, decode: Db });
var Lb = Object.freeze({ __proto__: null, base256emoji: $b }),
  qb = mf,
  ul = 128,
  Mb = 127,
  jb = ~Mb,
...
var kb = Math.pow(2, 7),
  ...
  Xb = { encode: qb, decode: Ub, encodingLength: Yb },
  wf = Xb;
  ...
  digest(r) {
    if (r instanceof Uint8Array) {
      ...
      return i instanceof Uint8Array
        ? vc(this.code, i)
        : i.then((n) => vc(this.code, n));
    } else throw Error("Unknown type, must be binary type");
  }
}
const bf = (a) => async (r) => new Uint8Array(await crypto.subtle.digest(a, r)),
  t1 = _f({ name: "sha2-256", code: 18, encode: bf("SHA-256") }),
  r1 = _f({ name: "sha2-512", code: 19, encode: bf("SHA-512") });
var i1 = Object.freeze({ __proto__: null, sha256: t1, sha512: r1 });
const Ef = 0,
  s1 = "identity",
  If = gf,
  n1 = (a) => vc(Ef, If(a)),
  o1 = { code: Ef, name: s1, encode: If, digest: n1 };
var a1 = Object.freeze({ __proto__: null, identity: o1 });
...
function c1(a = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null
    ? xf(globalThis.Buffer.allocUnsafe(a))
    : new Uint8Array(a);
}
function Pf(a, r, i, n) {
  return {
    name: a,
    prefix: r,
    encoder: { name: a, prefix: r, encode: i },
    decoder: { decode: n },
  };
}
const dl = Pf(
...
function h1(a, r = "utf8") {
  ...
  return (r === "utf8" || r === "utf-8") &&
    ...
    ? xf(globalThis.Buffer.from(a, "utf-8"))
    : i.decoder.decode(`${i.prefix}${a}`);
}
const Sf = "wc",
  l1 = 2,
  Ac = "core",
  xi = `${Sf}@2:${Ac}:`,
  f1 = { name: Ac, logger: "error" },
  p1 = { database: ":memory:" },
  d1 = "crypto",
  ...
  constructor(r, i, n) {
    (this.core = r),
      ...
      (this.encode = async (o, h, p) => {
        ...
        return b0({ type: I, symKey: v, message: _, senderPublicKey: R });
      }),
    ...
    super(r, i),
      ...
      (this.set = async (n, o) => {
        ...
        return (
          typeof p > "u" && (p = {}),
          typeof p[h] < "u" ||
            ((p[h] = o), this.messages.set(n, p), await this.persist()),
          h
        );
      }),
      (this.get = (n) => {
...
class F1 extends Bw {
      ...
      (this.publish = async (n, o, h) => {
        ...
        this.logger.debug("Publishing Payload"),
          this.logger.trace({
            type: "method",
            method: "publish",
            params: { topic: n, message: o, opts: h },
          });
        try {
          const g = (h == null ? void 0 : h.ttl) || _1,
            ...
            A = {
              topic: n,
              message: o,
              opts: { ttl: g, relay: _, prompt: v, tag: I, id: R },
            },
            z = setTimeout(() => this.queue.set(R, A), this.publishTimeout);
          try {
            await await Ys(
              this.rpcPublish(n, o, g, _, v, I, R),
              this.publishTimeout,
            ...
            if (
              ...
              (p = h == null ? void 0 : h.internal) != null &&
                p.throwOnFailedPublish)
            )
              throw (this.removeRequestFromQueue(R), T);
            return;
          } finally {
            clearTimeout(z);
          }
  ...
  rpcPublish(r, i, n, o, h, p, g) {
    ...
    const A = {
      ...
      params: { topic: r, message: i, ttl: n, prompt: h, tag: p },
      id: g,
    };
    return (
      Ii((_ = A.params) == null ? void 0 : _.prompt) &&
        ((v = A.params) == null || delete v.prompt),
      Ii((I = A.params) == null ? void 0 : I.tag) &&
        ((R = A.params) == null || delete R.tag),
...
var G1 = Object.defineProperty,
  ...
  ml = (a, r, i) =>
    r in a
      ? G1(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  Ks = (a, r) => {
    for (var i in r || (r = {})) Q1.call(r, i) && ml(a, i, r[i]);
    if (vl) for (var i of vl(r)) Y1.call(r, i) && ml(a, i, r[i]);
    return a;
  },
  oc = (a, r) => W1(a, J1(r));
class X1 extends Gw {
          ...
          : await new Promise((o, h) => {
              ...
              const g = setInterval(() => {
                !this.pending.has(n) &&
                  ...
                  o(!0)),
                  p.elapsed(this.pendingSubscriptionWatchLabel) >= N1 &&
                    (clearInterval(g),
                    p.stop(this.pendingSubscriptionWatchLabel),
  ...
  async rpcSubscribe(r, i) {
    const n = { method: fo(i.protocol).subscribe, params: { topic: r } };
    this.logger.debug("Outgoing Relay Payload"),
  ...
  onSubscribe(r, i) {
    this.setSubscription(r, oc(Ks({}, i), { id: r })),
  ...
  getSubscription(r) {
    this.logger.debug("Getting subscription"),
      this.logger.trace({ type: "method", method: "getSubscription", id: r });
  ...
  deleteSubscription(r, i) {
    ...
    this.subscriptions.delete(r),
      ...
      this.events.emit($r.deleted, oc(Ks({}, n), { reason: i }));
  }
  async persist() {
  ...
  async batchSubscribe(r) {
    ...
    ms(i) &&
      this.onBatchSubscribe(i.map((n, o) => oc(Ks({}, r[o]), { id: n })));
  }
  async onConnect() {
...
var Z1 = Object.defineProperty,
  ...
  _l = (a, r, i) =>
    r in a
      ? Z1(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  rE = (a, r) => {
    for (var i in r || (r = {})) eE.call(r, i) && _l(a, i, r[i]);
    if (wl) for (var i of wl(r)) tE.call(r, i) && _l(a, i, r[i]);
    return a;
  };
class iE extends Fw {
  constructor(r) {
    super(r),
      ...
      (this.request = async (i) => {
        ...
        try {
          return (
            await this.toEstablishConnection(), await this.provider.request(i)
          );
        } catch (n) {
          throw (
      ...
      (this.core = r.core),
      (this.logger =
        typeof r.logger < "u" && typeof r.logger != "string"
          ? Re.generateChildLogger(r.logger, this.name)
          : Re.pino(Re.getDefaultLoggerOptions({ level: r.logger || E1 }))),
  ...
  async init() {
    ...
    try {
      ...
      this.logger.warn(
        `Connection via ${this.relayUrl} failed, attempting to connect via failover domain ${yl}...`
      ),
  ...
  async subscribe(r, i) {
    ...
    this.isInitialized();
    let o =
      ((n = this.subscriber.topicMap.get(r)) == null ? void 0 : n[0]) || "";
    if (o) return o;
    let h;
    const p = (g) => {
  ...
  async shouldIgnoreMessageEvent(r) {
    ...
    if (!(await this.subscriber.isSubscribed(i)))
      return (
        this.logger.debug(`Ignoring message for non-subscribed topic ${i}`), !0
      );
  ...
  async onProviderPayload(r) {
    if (
      ...
      this.logger.trace({ type: "payload", direction: "incoming", payload: r }),
      Cc(r))
    ) {
      if (!r.method.endsWith(x1)) return;
      const i = r.params,
        { topic: n, message: o, publishedAt: h } = i.data,
        p = { topic: n, message: o, publishedAt: h };
      this.logger.debug("Emitting Relayer Payload"),
        this.logger.trace(rE({ type: "event", event: i.id }, p)),
  ...
  async onMessageEvent(r) {
    (await this.shouldIgnoreMessageEvent(r)) ||
      (this.events.emit(Wt.message, r), await this.recordMessageEvent(r));
  }
...
var sE = Object.defineProperty,
  ...
  El = (a, r, i) =>
    r in a
      ? sE(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  Il = (a, r) => {
    for (var i in r || (r = {})) nE.call(r, i) && El(a, i, r[i]);
    if (bl) for (var i of bl(r)) oE.call(r, i) && El(a, i, r[i]);
    return a;
  };
class Po extends Vw {
  constructor(r, i, n, o = xi, h = void 0) {
    super(r, i, n, o),
      ...
      (this.init = async () => {
        this.initialized ||
          ...
          this.cached.forEach((p) => {
            this.getKey && p !== null && !Ii(p)
              ? this.map.set(this.getKey(p), p)
              : g0(p)
              ? this.map.set(p.id, p)
              : y0(p) && this.map.set(p.topic, p);
          }),
          (this.cached = []),
          (this.initialized = !0));
      }),
      ...
      (this.get = (p) => (
        ...
        this.logger.trace({ type: "method", method: "get", key: p }),
        this.getData(p)
      )),
      (this.getAll = (p) => (
        this.isInitialized(),
        p
          ? this.values.filter((g) =>
              Object.keys(p).every((_) => L_(g[_], p[_]))
            )
          : this.values
      )),
...
class aE {
    ...
    (this.core = r),
      ...
      (this.create = async () => {
        ...
        const n = pc(),
          ...
          p = { protocol: Of },
          g = { topic: o, expiry: h, relay: p, active: !1 },
          _ = C0({
      ...
      (this.pair = async (n) => {
        ...
        const _ = Lr(se.FIVE_MINUTES),
          v = { topic: o, relay: p, expiry: _, active: !1 };
        return (
          ...
          this.core.crypto.keychain.has(o) ||
            ...
            await this.core.relayer.subscribe(o, { relay: p })),
          v
        );
      }),
      ...
      (this.sendRequest = async (n, o, h) => {
        const p = vs(o, h),
          ...
          _ = ks[o].req;
        return (
          this.core.history.set(n, p), this.core.relayer.publish(n, g, _), p.id
        );
      }),
      ...
      (this.sendError = async (n, o, h) => {
        const p = Eo(n, h),
          g = await this.core.crypto.encode(o, p),
          _ = await this.core.history.get(o, n),
          v = ks[_.request.method]
            ? ks[_.request.method].res
      ...
      (this.onPairingPingRequest = async (n, o) => {
        ...
        try {
          this.isValidPing({ topic: n }),
            ...
            this.events.emit(Ws.ping, { id: h, topic: n });
        } catch (p) {
      ...
      (this.onPairingPingResponse = (n, o) => {
        ...
        setTimeout(() => {
          ci(o)
            ...
            : qr(o) &&
              this.events.emit(Dt("pairing_ping", h), { error: o.error });
        }, 500);
      }),
      (this.onPairingDeleteRequest = async (n, o) => {
        ...
        try {
          this.isValidDisconnect({ topic: n }),
            ...
            this.events.emit(Ws.delete, { id: h, topic: n });
        } catch (p) {
          await this.sendError(h, n, p), this.logger.error(p);
        }
      }),
      ...
      try {
        Cc(o)
          ? (this.core.history.set(i, o),
            this.onRelayEventRequest({ topic: i, payload: o }))
          : Io(o) &&
            (await this.core.history.resolve(o),
            await this.onRelayEventResponse({ topic: i, payload: o }),
  ...
  registerExpirerEvents() {
    this.core.expirer.on(Sr.expired, async (r) => {
      ...
      i &&
        this.pairings.keys.includes(i) &&
        (await this.deletePairing(i, !0),
        this.events.emit(Ws.expire, { topic: i }));
    });
  }
}
class cE extends kw {
  constructor(r, i) {
    super(r, i),
      ...
      (this.resolve = async (n) => {
        ...
        typeof o.response > "u" &&
          ((o.response = qr(n) ? { error: n.error } : { result: n.result }),
  ...
  registerEventListeners() {
    this.events.on(Fr.created, (r) => {
      const i = Fr.created;
      this.logger.info(`Emitting ${i}`),
        this.logger.debug({ type: "event", event: i, record: r }),
        this.persist();
    }),
  ...
  cleanup() {
    try {
      this.records.forEach((r) => {
        se.toMiliseconds(r.expiry || 0) - Date.now() <= 0 &&
...
class uE extends Ww {
    ...
    super(r, i),
      ...
      (this.set = (n, o) => {
        ...
        this.expirations.set(h, p),
          ...
          this.events.emit(Sr.created, { target: h, expiration: p });
      }),
      (this.get = (n) => {
        this.isInitialized();
        const o = this.formatTarget(n);
      ...
      (this.del = (n) => {
        if ((this.isInitialized(), this.has(n))) {
          ...
          this.expirations.delete(o),
            this.events.emit(Sr.deleted, { target: o, expiration: h });
        }
      }),
      (this.on = (n, o) => {
        this.events.on(n, o);
  ...
  expire(r, i) {
    this.expirations.delete(r),
      this.events.emit(Sr.expired, { target: r, expiration: i });
  }
  checkExpirations() {
    this.core.relayer.connected &&
      this.expirations.forEach((r, i) => this.checkExpiry(i, r));
  }
  registerEventListeners() {
    this.core.heartbeat.on(_s.HEARTBEAT_EVENTS.pulse, () =>
    ...
    super(r, i),
      ...
      (this.resolve = async (n) => {
        ...
        try {
          ...
          this.logger.info(
            `failed to resolve attestation: ${n.attestationId} from url: ${o}`
          ),
            this.logger.info(p),
      ...
      (this.getVerifyUrl = (n) => {
        ...
        return (
          z1.includes(o) ||
            (this.logger.info(
              `verify url: ${o}, not included in trusted list, assigning default: ${gs}`
            ),
            (o = gs)),
          o
        );
...
var fE = Object.defineProperty,
  ...
  Pl = (a, r, i) =>
    r in a
      ? fE(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  Sl = (a, r) => {
    for (var i in r || (r = {})) pE.call(r, i) && Pl(a, i, r[i]);
    if (xl) for (var i of xl(r)) dE.call(r, i) && Pl(a, i, r[i]);
    return a;
  };
class Tc extends Hw {
  constructor(r) {
    super(r),
      ...
      (this.customStoragePrefix =
        r != null && r.customStoragePrefix ? `:${r.customStoragePrefix}` : "");
    const i =
      typeof (r == null ? void 0 : r.logger) < "u" &&
      typeof (r == null ? void 0 : r.logger) != "string"
        ? r.logger
        : Re.pino(
    ...
    (this.logger = Re.generateChildLogger(i, this.name)),
      ...
      (this.storage =
        r != null && r.storage
          ? r.storage
          : new Nw(Sl(Sl({}, p1), r == null ? void 0 : r.storageOptions))),
      (this.relayer = new iE({
        core: this,
        logger: this.logger,
        relayUrl: this.relayUrl,
...
const gE = Tc,
  ...
  Bs = {
    ...
    wc_sessionPing: {
      req: { ttl: se.THIRTY_SECONDS, prompt: !1, tag: 1114 },
      res: { ttl: se.THIRTY_SECONDS, prompt: !1, tag: 1115 },
    },
  },
  cc = { min: se.FIVE_MINUTES, max: se.SEVEN_DAYS },
  ai = { idle: "IDLE", active: "ACTIVE" },
  wE = "request",
...
var bE = Object.defineProperty,
  ...
  Cl = (a, r, i) =>
    r in a
      ? bE(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  cr = (a, r) => {
    for (var i in r || (r = {})) xE.call(r, i) && Cl(a, i, r[i]);
    if (Rl) for (var i of Rl(r)) PE.call(r, i) && Cl(a, i, r[i]);
    return a;
  },
  Fs = (a, r) => EE(a, IE(r));
class SE extends Xw {
  constructor(r) {
    super(r),
      ...
      (this.initialized = !1),
      (this.ignoredPayloadTypes = [Vl]),
      (this.requestQueue = { state: ai.idle, queue: [] }),
      (this.sessionRequestQueue = { state: ai.idle, queue: [] }),
      ...
      (this.init = async () => {
        this.initialized ||
          ...
          this.client.core.pairing.register({ methods: Object.keys(Bs) }),
          (this.initialized = !0),
          setTimeout(() => {
      ...
      (this.connect = async (i) => {
        ...
        let v = o,
          ...
          R = !1;
        if (
          (v && (R = this.client.core.pairing.pairings.get(v).active), !v || !R)
        ) {
          const { topic: fe, uri: pe } =
        ...
        return (
          await this.setProposal(he, cr({ id: he, expiry: le }, z)),
          { uri: I, approval: re }
        );
      }),
      (this.pair = async (i) => (
        await this.isInitialized(), await this.client.core.pairing.pair(i)
      )),
      (this.approve = async (i) => {
        ...
        _ &&
          ...
          await this.sendResult({
            id: n,
            topic: _,
            result: { relay: { protocol: o ?? "irn" }, responderPublicKey: A },
          }),
        ...
        return (
          ...
          await this.setExpiry(T, Lr(uo)),
          {
            ...
            acknowledged: () =>
              new Promise((he) =>
                setTimeout(() => he(this.client.session.get(T)), 500)
              ),
          }
        );
      }),
      ...
      (this.update = async (i) => {
        ...
        const { topic: n, namespaces: o } = i,
          ...
          { done: p, resolve: g, reject: _ } = ps();
        return (
          this.events.once(Dt("session_update", h), ({ error: v }) => {
            v ? _(v) : g();
          }),
      ...
      (this.extend = async (i) => {
        ...
        return (
          this.events.once(Dt("session_extend", o), ({ error: _ }) => {
            _ ? g(_) : p();
          }),
        ...
        return (
          ...
          await Promise.all([
            ...
            new Promise(async (R) => {
              ...
              j0({ id: g, topic: h, wcDeepLink: A }), R();
            }),
            _(),
          ]).then((R) => R[2])
        );
          ...
          try {
            const n = this.client.core.pairing.pairings.get(i.pairingTopic),
              o = this.client.core.pairing.pairings.getAll().filter((h) => {
                var p, g;
                return (
                  ((p = h.peerMetadata) == null ? void 0 : p.url) &&
      ...
      (this.deleteProposal = async (i, n) => {
        await Promise.all([
          this.client.proposal.delete(i, Gt("USER_DISCONNECTED")),
          n ? Promise.resolve() : this.client.core.expirer.del(i),
        ]);
      }),
      (this.deletePendingSessionRequest = async (i, n, o = !1) => {
        await Promise.all([
          this.client.pendingRequest.delete(i, n),
          o ? Promise.resolve() : this.client.core.expirer.del(i),
        ]),
          (this.sessionRequestQueue.queue =
            this.sessionRequestQueue.queue.filter((h) => h.id !== i)),
          o && (this.sessionRequestQueue.state = ai.idle);
      }),
      (this.setExpiry = async (i, n) => {
        this.client.session.keys.includes(i) &&
          (await this.client.session.update(i, { expiry: n })),
      ...
      (this.sendRequest = async (i) => {
        ...
        if (Wl() && _E.includes(o)) {
          ...
          this.client.core.verify.register({ attestationId: z });
        }
        ...
        return (
          ...
          v
            ? ((A.internal = Fs(cr({}, A.internal), {
                throwOnFailedPublish: !0,
              })),
              await this.client.core.relayer.publish(n, R, A))
      ...
      (this.sendResult = async (i) => {
        ...
        p
          ? ((I.internal = Fs(cr({}, I.internal), {
              throwOnFailedPublish: !0,
            })),
            await this.client.core.relayer.publish(o, _, I))
          : this.client.core.relayer
              .publish(o, _, I)
              .catch((R) => this.client.logger.error(R)),
      ...
      (this.onSessionProposeRequest = async (i, n) => {
        ...
        try {
          ...
          const p = Lr(se.FIVE_MINUTES),
            g = cr({ id: h, pairingTopic: i, expiry: p }, o);
      ...
      (this.onSessionSettleRequest = async (i, n) => {
        ...
        try {
          ...
          await this.sendResult({ id: n.id, topic: i, result: !0 }),
            this.events.emit(Dt("session_connect"), { session: T }),
      ...
      (this.onSessionSettleResponse = async (i, n) => {
        ...
        ci(n)
          ...
          : qr(n) &&
            (await this.client.session.delete(i, Gt("USER_DISCONNECTED")),
            this.events.emit(Dt("session_approve", o), { error: n.error }));
      }),
      (this.onSessionUpdateRequest = async (i, n) => {
        ...
        try {
          ...
          this.isValidUpdate(cr({ topic: i }, o)),
            await this.client.session.update(i, { namespaces: o.namespaces }),
            await this.sendResult({ id: h, topic: i, result: !0 }),
      ...
      (this.isRequestOutOfSync = (i, n) =>
        parseInt(n.toString().slice(0, -3)) <=
        parseInt(i.toString().slice(0, -3))),
      (this.onSessionUpdateResponse = (i, n) => {
        const { id: o } = n;
        ci(n)
          ? this.events.emit(Dt("session_update", o), {})
          : qr(n) &&
            this.events.emit(Dt("session_update", o), { error: n.error });
      }),
      (this.onSessionExtendRequest = async (i, n) => {
        ...
        try {
          this.isValidExtend({ topic: i }),
            ...
            await this.sendResult({ id: o, topic: i, result: !0 }),
            this.client.events.emit("session_extend", { id: o, topic: i });
        } catch (h) {
      ...
      (this.onSessionExtendResponse = (i, n) => {
        const { id: o } = n;
        ci(n)
          ? this.events.emit(Dt("session_extend", o), {})
          : qr(n) &&
            this.events.emit(Dt("session_extend", o), { error: n.error });
      }),
      (this.onSessionPingRequest = async (i, n) => {
        ...
        try {
          this.isValidPing({ topic: i }),
            await this.sendResult({ id: o, topic: i, result: !0 }),
            this.client.events.emit("session_ping", { id: o, topic: i });
        } catch (h) {
          await this.sendError(o, i, h), this.client.logger.error(h);
        }
      }),
      (this.onSessionPingResponse = (i, n) => {
        ...
        setTimeout(() => {
          ci(n)
            ? this.events.emit(Dt("session_ping", o), {})
            : qr(n) &&
              this.events.emit(Dt("session_ping", o), { error: n.error });
        }, 500);
      }),
      (this.onSessionDeleteRequest = async (i, n) => {
        const { id: o } = n;
        try {
          this.isValidDisconnect({ topic: i, reason: n.params }),
            await Promise.all([
              new Promise((h) => {
              ...
              this.sendResult({ id: o, topic: i, result: !0 }),
            ]),
            this.client.events.emit("session_delete", { id: o, topic: i });
        } catch (h) {
      ...
      (this.onSessionRequest = async (i, n) => {
        const { id: o, params: h } = n;
        try {
          this.isValidRequest(cr({ topic: i }, h));
          const p = ys(JSON.stringify(vs("wc_sessionRequest", h, o))),
            ...
            v = { id: o, topic: i, params: h, verifyContext: _ };
      ...
      (this.onSessionRequestResponse = (i, n) => {
        const { id: o } = n;
        ci(n)
          ? this.events.emit(Dt("session_request", o), { result: n.result })
          : qr(n) &&
            this.events.emit(Dt("session_request", o), { error: n.error });
      }),
      ...
      (this.isValidApprove = async (i) => {
        if (!hr(i))
          throw new Error(
            Y("MISSING_OR_INVALID", `approve() params: ${i}`).message
          );
        const {
          id: n,
          namespaces: o,
      ...
      (this.isValidRequest = async (i) => {
        ...
        if (p && !G0(p, cc)) {
          const { message: _ } = Y(
            "MISSING_OR_INVALID",
            `request() expiry: ${p}. Expiry must be a number (in seconds) between ${cc.min} and ${cc.max}`
          );
          throw new Error(_);
        }
      }),
      (this.isValidRespond = async (i) => {
        ...
        try {
          ...
          throw (
            ((n = i == null ? void 0 : i.response) != null &&
              n.id &&
              this.cleanupAfterResponse(i),
            p)
          );
  ...
  registerRelayerEvents() {
    this.client.core.relayer.on(Wt.message, async (r) => {
      ...
      try {
        Cc(o)
          ? (this.client.core.history.set(i, o),
            this.onRelayEventRequest({ topic: i, payload: o }))
          : Io(o)
          ? (await this.client.core.history.resolve(o),
            await this.onRelayEventResponse({ topic: i, payload: o }),
            this.client.core.history.delete(i, o.id))
          : this.onRelayEventUnknownPayload({ topic: i, payload: o });
      } catch (h) {
        this.client.logger.error(h);
      }
    });
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(Sr.expired, async (r) => {
      ...
      i
        ? this.client.session.keys.includes(i) &&
          (await this.deleteSession(i, !0),
          this.client.events.emit("session_expire", { topic: i }))
        : n &&
  ...
  registerPairingEvents() {
    this.client.core.pairing.events.on(Ws.create, (r) =>
  ...
  async isValidSessionTopic(r) {
    if (!ds(r, !1)) {
      const { message: i } = Y(
        "MISSING_OR_INVALID",
        `session topic should be a string: ${r}`
      );
      throw new Error(i);
    }
  ...
  async isValidSessionOrPairingTopic(r) {
    if (this.client.session.keys.includes(r)) await this.isValidSessionTopic(r);
      ...
      const { message: i } = Y(
        "NO_MATCHING_KEY",
        `session or pairing topic doesn't exist: ${r}`
      );
      throw new Error(i);
    } else {
      const { message: i } = Y(
        "MISSING_OR_INVALID",
        `session or pairing topic should be a string: ${r}`
      );
      throw new Error(i);
    }
  }
  async isValidProposalId(r) {
    if (!Y0(r)) {
      const { message: i } = Y(
        "MISSING_OR_INVALID",
        `proposal id should be a number: ${r}`
      );
      throw new Error(i);
    }
...
(function (a, r) {
  ...
  (function (h) {
    (function (p) {
      ...
      function fe(m) {
        for (
          var x = new Uint8Array(m), X = new Array(x.length), ce = 0;
          ce < x.length;
          ce++
        )
            ...
            (this._bodyInit = m),
              m
                ? typeof m == "string"
                  ...
                  : g.arrayBuffer && g.blob && _(m)
                  ? ((this._bodyArrayBuffer = pe(m.buffer)),
                    (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                  : g.arrayBuffer &&
                    (ArrayBuffer.prototype.isPrototypeOf(m) || I(m))
      ...
      return (
        (Ue.polyfill = !0),
        h.fetch ||
          ((h.fetch = Ue), (h.Headers = T), (h.Request = W), (h.Response = ue)),
        (p.Headers = T),
        (p.Request = W),
        (p.Response = ue),
        (p.fetch = Ue),
...
var TE = wc.exports;
const Al = xc(TE),
  NE = { Accept: "application/json", "Content-Type": "application/json" },
  DE = "POST",
  Tl = { headers: NE, method: DE },
  Nl = 10;
class Si {
  constructor(r, i = !1) {
    if (
      ...
      throw new Error(
        `Provided URL is not compatible with HTTP connection: ${r}`
      );
  ...
  async send(r, i) {
    ...
    try {
      const n = Ki(r),
        h = await (
          await Al(this.url, Object.assign(Object.assign({}, Tl), { body: n }))
        ).json();
  ...
  async register(r = this.url) {
    ...
    try {
      if (!this.disableProviderPing) {
        const i = Ki({ id: 1, jsonrpc: "2.0", method: "test", params: [] });
        await Al(r, Object.assign(Object.assign({}, Tl), { body: i }));
      }
      this.onOpen();
    } catch (i) {
      const n = this.parseError(i);
 ...
 */ (function (a, r) {
  (function () {
    ...
    function pi(S, q) {
      for (
        var N = -1, Z = S == null ? 0 : S.length, ye = 0, Le = [];
        ++N < Z;
    ...
    function Zf(S, q, N) {
      for (var Z = N - 1, ye = S.length; ++Z < ye; ) if (S[Z] === q) return Z;
      return -1;
    }
    function ep(S, q, N) {
      for (var Z = N + 1; Z--; ) if (S[Z] === q) return Z;
      return Z;
    }
    function rs(S) {
    ...
    var np = function S(q) {
        ...
        function Qp(e, t) {
          ...
          if (s instanceof Jr) {
            var c = s.__data__;
            if (!Os || c.length < o - 1)
              return c.push([e, t]), (this.size = ++s.size), this;
        ...
        function Ts(e, t, s) {
          var c = e[t];
          (!(ze.call(e, t) && Nr(c, s)) || (s === i && !(t in e))) &&
            Yr(e, t, s);
        }
        function jn(e, t) {
          for (var s = e.length; s--; ) if (Nr(e[s][0], t)) return s;
          return -1;
        }
        function Zp(e, t, s, c) {
          return (
        ...
        function Ns(e, t, s, c) {
          ...
          s && (t = st(t, fr(s))),
            c
              ? ((d = Go), (w = !1))
              : t.length >= o && ((d = Ps), (w = !1), (t = new Li(t)));
          e: for (; ++l < b; ) {
            var j = e[l],
              K = s == null ? j : s(j);
            if (((j = c || j !== 0 ? j : 0), w && K === K)) {
              for (var J = M; J--; ) if (t[J] === K) continue e;
              O.push(j);
        ...
        function la(e, t, s) {
          ...
          e: for (; ++K < l && M.length < O; ) {
            var te = j[K],
              oe = t ? t(te) : te;
            if (
              ((te = s || te !== 0 ? te : 0), !(J ? Ps(J, oe) : c(M, oe, s)))
            ) {
              for (w = d; --w; ) {
                var Ee = b[w];
        ...
        function gu(e, t, s) {
          ...
          var l = lu(e, function (d, w, b) {
            ...
            return { criteria: O, index: ++c, value: d };
          });
        ...
        function ga(e, t, s, c) {
          ...
          for (e === t && (t = sr(t)), s && (b = st(e, fr(s))); ++d < w; )
            for (
              var O = 0, M = t[d], j = s ? s(M) : M;
              (O = l(b, j, O, c)) > -1;

            )
              b !== e && Tn.call(b, O, 1), Tn.call(e, O, 1);
          return e;
        }
        function vu(e, t) {
        ...
        function ma(e, t, s, c) {
          ...
          t = s(t);
          for (
            var w = t !== t, b = t === null, O = dr(t), M = t === i;
            l < d;
        ...
        function mi(e, t, s) {
          ...
          e: for (; ++c < d; ) {
            ...
            if (((j = s || j !== 0 ? j : 0), w && K === K)) {
              for (var J = O.length; J--; ) if (O[J] === K) continue e;
              t && O.push(K), b.push(j);
        ...
        function wa(e, t) {
          return (
            (t = wi(t, e)), (e = Wu(e, t)), e == null || delete e[Br(xr(t))]
          );
        }
        function bu(e, t, s, c) {
        ...
        function cs(e) {
          return xe(function (t, s) {
            var c = -1,
              ...
              w = l > 2 ? s[2] : i;
            for (
              d = e.length > 3 && typeof d == "function" ? (l--, d) : i,
                w && Zt(s[0], s[1], w) && ((d = l < 3 ? i : d), (l = 1)),
                t = We(t);
              ++c < l;
        ...
        function $u(e) {
          return Zr(function (t) {
            ...
            for (c = w ? c : s; ++c < s; ) {
              ...
              !O[4].length &&
              O[9] == 1
                ? (w = w[Jn(O[0])].apply(w, O[3]))
                : (w = d.length == 1 && Na(d) ? w[b]() : w.thru(d));
            }
            return function () {
              var M = arguments,
                j = M[0];
          ...
          function w() {
            for (
              var b = -1,
                ...
                j = c.length,
                K = N(j + O),
                J = this && this !== Ce && this instanceof w ? d : e;
              ++M < j;
        ...
        function qu(e) {
          return function (t, s, c) {
            return (
              c && typeof c != "number" && Zt(t, s, c) && (s = c = i),
              (t = ri(t)),
              s === i ? ((s = t), (t = 0)) : (s = ri(s)),
              (c = c === i ? (t < s ? 1 : -1) : ri(c)),
              wd(t, s, c, e)
        ...
        function Pa(e) {
          ...
          return function (s, c) {
            if (
              ((s = Pr(s)), (c = c == null ? 0 : Ft(_e(c), 292)), c && Qc(s))
            ) {
              var l = (Me(s) + "e").split("e"),
                d = t(l[0] + "e" + (+l[1] + c));
              return (
                (l = (Me(d) + "e").split("e")), +(l[0] + "e" + (+l[1] - c))
              );
            }
            return t(s);
          };
        ...
        function Uu(e, t, s, c, l, d) {
          return (
            ut(e) && ut(t) && (d.set(t, e), Hn(e, t, i, Uu, d), d.delete(t)), e
          );
        }
        function qd(e) {
          return zs(e) ? i : e;
        ...
        function Md(e, t, s, c, l, d, w) {
          switch (s) {
            ...
            case De:
              return !(
                e.byteLength != t.byteLength || !d(new Cn(e), new Cn(t))
              );
            case D:
            case C:
            case Ne:
        ...
        function Jn(e) {
          for (
            var t = e.name + "", s = os[t], c = ze.call(os, t) ? s.length : 0;
            c--;
        ...
        var Aa = ia
          ...
          ku = ia
            ...
            : Wa,
          Vt = Xt;
        ((sa && Vt(new sa(new ArrayBuffer(1))) != Be) ||
          (Os && Vt(new Os()) != be) ||
          (na && Vt(na.resolve()) != xt) ||
          (ns && Vt(new ns()) != qe) ||
          (Rs && Vt(new Rs()) != He)) &&
...
`
        ...
        function Zt(e, t, s) {
          ...
          var c = typeof t;
          return (
            c == "number" ? nr(s) && ei(t, s.length) : c == "string" && t in s
          )
            ? Nr(s[t], e)
            : !1;
        }
        function Ta(e, t) {
          ...
          return s == "number" ||
            ...
            dr(e)
            ? !0
            : St.test(e) || !it.test(e) || (t != null && e in We(t));
        }
        function Vd(e) {
          var t = typeof e;
          return t == "string" ||
        ...
        function Qd(e, t) {
          var s = e[1],
            ...
            w =
              (c == H && s == fe) ||
              (c == H && s == W && e[7].length <= t[8]) ||
              (c == (H | W) && t[7].length <= t[8] && s == fe);
          if (!(d || w)) return e;
        ...
        function Yd(e) {
          var t = [];
          if (e != null) for (var s in We(e)) t.push(s);
          return t;
        }
        function Xd(e) {
          return On.call(e);
        ...
        function Gu(e, t, s) {
          return (
            ...
            function () {
              for (
                var c = arguments, l = -1, d = qt(c.length - t, 0), w = N(d);
                ++l < d;
        ...
        function rg(e) {
          for (
            var t = -1, s = e == null ? 0 : e.length, c = 0, l = [];
            ++t < s;
        ...
        var sg = xe(function (e, t) {
          ...
          ng = xe(function (e, t) {
            var s = xr(t);
            return (
              bt(s) && (s = i), bt(e) ? Ns(e, Kt(t, 1, bt, !0), ne(s, 2)) : []
            );
          }),
          og = xe(function (e, t) {
            var s = xr(t);
        ...
        function lg(e, t, s, c) {
          ...
          return l
            ? (s && typeof s != "number" && Zt(e, t, s) && ((s = 0), (c = l)),
              id(e, t, s, c))
            : [];
        }
        function eh(e, t, s) {
        ...
        function th(e, t, s) {
          ...
          var l = c - 1;
          return (
            s !== i && ((l = _e(s)), (l = s < 0 ? qt(c + l, 0) : Ft(l, c - 1))),
            En(e, ne(t, 3), l, !0)
          );
        }
        function rh(e) {
        ...
        function bg(e, t, s) {
          ...
          var l = c;
          return (
            s !== i && ((l = _e(s)), (l = l < 0 ? qt(c + l, 0) : Ft(l, c - 1))),
        ...
        var kg = xe(function (e) {
          ...
          Bg = xe(function (e) {
            var t = xr(e);
            return (
              (t = typeof t == "function" ? t : i), mi(Kt(e, 1, bt, !0), i, t)
            );
          });
        function Fg(e) {
        ...
        var iy = Zr(function (e) {
          ...
          return t > 1 ||
            ...
            ? this.thru(l)
            : ((c = c.slice(s, +s + (t ? 1 : 0))),
              c.__actions__.push({ func: Xn, args: [l], thisArg: i }),
        ...
        function uy() {
          ...
          if (e instanceof Oe) {
            var t = e;
            return (
              this.__actions__.length && (t = new Oe(this)),
              (t = t.reverse()),
              t.__actions__.push({ func: Xn, args: [La], thisArg: i }),
        ...
        function Ky(e, t, s) {
          ...
          return (
            ...
            dh(e, t, { leading: c, maxWait: t, trailing: l })
          );
        }
        function By(e) {
          return uh(e, 1);
        ...
        function sv(e) {
          ...
          for (var s in e) if (ze.call(e, s)) return !1;
          return !0;
        }
        function nv(e, t) {
          return $s(e, t);
        ...
        function Gv(e, t, s, c) {
          return (
            (c = typeof c == "function" ? c : i), e == null ? e : Ls(e, t, s, c)
          );
        }
        var Sh = ju(zt),
          Oh = ju(or);
        ...
        function Zv(e, t, s) {
          return (
            s === i && ((s = t), (t = i)),
            s !== i && ((s = Pr(s)), (s = s === s ? s : 0)),
            t !== i && ((t = Pr(t)), (t = t === t ? t : 0)),
            qi(Pr(e), t, s)
          );
        }
        function em(e, t, s) {
        ...
        function tm(e, t, s) {
          if (
            (s && typeof s != "boolean" && Zt(e, t, s) && (t = s = i),
            s === i &&
              (typeof t == "boolean"
                ? ((s = t), (t = i))
        ...
        function pm(e, t, s) {
          return (
            (s ? Zt(e, t, s) : t === i) ? (t = 1) : (t = _e(t)), va(Me(e), t)
          );
        }
        function dm() {
          var e = arguments,
        ...
        function ym(e, t, s) {
          return (
            s && typeof s != "number" && Zt(e, t, s) && (t = s = i),
            (s = s === i ? G : s >>> 0),
            s
              ? ((e = Me(e)),
                e &&
                (typeof t == "string" || (t != null && !Ua(t))) &&
                ((t = pr(t)), !t && ts(e))
                  ? _i(Ar(e), 0, s)
                  : e.split(t, s))
              : []
...
`) +
          ...
          if ((w && (b += O.length - b), Ua(l))) {
            if (e.slice(b).search(l)) {
              var M,
                j = O;
              for (
                l.global || (l = ra(l.source, Me(vr.exec(l)) + "g")),
                  l.lastIndex = 0;
                (M = l.exec(j));
        ...
        function Va(e, t, s) {
          var c = zt(t),
            l = Un(t, c);
          s == null &&
            !(ut(t) && (l.length || !c.length)) &&
            ((s = t), (t = e), (e = this), (l = Un(t, zt(t))));
                ...
                w &&
                  (e.prototype[b] = function () {
                    ...
                    if (d || M) {
                      ...
                      return (
                        K.push({ func: O, args: arguments, thisArg: e }),
                        (j.__chain__ = M),
                        j
                      );
                    }
        ...
        return (
          ...
          wr(["drop", "take"], function (e, t) {
            (Oe.prototype[e] = function (s) {
              ...
              return (
                c.__filtered__
                  ? (c.__takeCount__ = Ft(s, c.__takeCount__))
                  : c.__views__.push({
                      size: Ft(s, G),
          ...
          wr(["filter", "map", "takeWhile"], function (e, t) {
            ...
            Oe.prototype[e] = function (l) {
              var d = this.clone();
              return (
                d.__iteratees__.push({ iteratee: ne(l, 3), type: s }),
          ...
          (Oe.prototype.slice = function (e, t) {
            ...
            return s.__filtered__ && (e > 0 || t < 0)
              ...
              : (e < 0 ? (s = s.takeRight(-e)) : e && (s = s.drop(e)),
                t !== i &&
                  ((t = _e(t)), (s = t < 0 ? s.dropRight(-t) : s.take(t - e))),
                s);
          }),
            ...
            l &&
              (f.prototype[t] = function () {
                ...
                if (!d && j) {
                  ...
                  var ae = e.apply(w, b);
                  return (
                    ae.__actions__.push({ func: Xn, args: [K], thisArg: i }),
                    new br(ae, J)
                  );
                }
                return oe && Ee
          ...
          kr(Oe.prototype, function (e, t) {
            ...
            if (s) {
              var c = s.name + "";
              ze.call(os, c) || (os[c] = []), os[c].push({ name: t, func: s });
            }
          }),
          (os[Fn(i, he).name] = [{ name: "wrapper", func: i }]),
...
var jE = Object.defineProperty,
  ...
  ql = (a, r, i) =>
    r in a
      ? jE(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  ho = (a, r) => {
    for (var i in r || (r = {})) HE.call(r, i) && ql(a, i, r[i]);
    if (Ll) for (var i of Ll(r)) kE.call(r, i) && ql(a, i, r[i]);
    return a;
  },
  KE = (a, r) => zE(a, UE(r));
function Pi(a, r, i) {
  ...
  const o = X0(a);
  return (
    ((n = r.rpcMap) == null ? void 0 : n[o.reference]) ||
    `${ME}?chainId=${o.namespace}:${o.reference}&projectId=${i}`
  );
}
function Vi(a) {
...
function GE(a) {
  ...
  for (const [i, n] of Object.entries(a)) {
    ...
    r[i] = { chains: g, methods: o, events: h, accounts: p };
  }
  return r;
}
function uc(a) {
...
class WE {
  ...
  request(r) {
    return this.namespace.methods.includes(r.request.method)
      ? this.client.request(r)
      : this.getHttpProvider().request(r.request);
  }
  setDefaultChain(r, i) {
  ...
  createHttpProviders() {
    ...
    return (
      this.namespace.chains.forEach((i) => {
        var n;
        const o = Vi(i);
        r[o] = this.createHttpProvider(
          o,
          (n = this.namespace.rpcMap) == null ? void 0 : n[i]
        );
      }),
      r
    );
...
class JE {
  ...
  createHttpProvider(r, i) {
    const n =
      i || Pi(`${this.name}:${r}`, this.namespace, this.client.core.projectId);
    if (!n) throw new Error(`No RPC url provided for chainId: ${r}`);
    return new ui(new Si(n, nt("disableProviderPing")));
  }
  setHttpProvider(r, i) {
  ...
  async handleSwitchChain(r) {
    var i, n;
    let o = r.request.params
      ? (i = r.request.params[0]) == null
        ? void 0
        : i.chainId
      : "0x0";
    ...
    if (this.isChainApproved(h)) this.setDefaultChain(`${h}`);
      ...
      await this.client.request({
        topic: r.topic,
        request: { method: r.request.method, params: [{ chainId: o }] },
...
var rI = Object.defineProperty,
  ...
  zl = (a, r, i) =>
    r in a
      ? rI(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  lo = (a, r) => {
    for (var i in r || (r = {})) nI.call(r, i) && zl(a, i, r[i]);
    if (jl) for (var i of jl(r)) oI.call(r, i) && zl(a, i, r[i]);
    return a;
  },
  lc = (a, r) => iI(a, sI(r));
class Dc {
  constructor(r) {
    (this.events = new Pc()),
      ...
      (this.disableProviderPing =
        (r == null ? void 0 : r.disableProviderPing) || !1);
  }
  static async init(r) {
    const i = new Dc(r);
    return await i.initialize(), i;
      ...
      n && ((this.uri = n), this.events.emit("display_uri", n)),
        await o()
          .then((h) => {
            (this.session = h),
              this.namespaces ||
                ((this.namespaces = GE(h.namespaces)),
  ...
  createProviders() {
    ...
    const r = [
      ...new Set(Object.keys(this.session.namespaces).map((i) => Gs(i))),
    ];
    hc("client", this.client),
      ...
      r.forEach((i) => {
        ...
        const n = BE(i, this.session),
          ...
          p = lc(lo({}, h[i]), { accounts: n, chains: o });
        switch (i) {
          case "eip155":
            this.rpcProviders[i] = new JE({ namespace: p });
            break;
          case "solana":
            this.rpcProviders[i] = new QE({ namespace: p });
            break;
          case "cosmos":
            this.rpcProviders[i] = new YE({ namespace: p });
            break;
          case "polkadot":
            this.rpcProviders[i] = new WE({ namespace: p });
            break;
          case "cip34":
            this.rpcProviders[i] = new XE({ namespace: p });
            break;
          case "elrond":
            this.rpcProviders[i] = new ZE({ namespace: p });
            break;
          case "multiversx":
            this.rpcProviders[i] = new eI({ namespace: p });
            break;
          case "near":
            this.rpcProviders[i] = new tI({ namespace: p });
            break;
        }
      });
  }
  registerEventListeners() {
    ...
    this.client.on("session_ping", (r) => {
      ...
      this.client.on("session_update", ({ topic: r, params: i }) => {
        ...
        (this.session = lc(lo({}, h), { namespaces: o })),
          this.onSessionUpdate(),
          this.events.emit("session_update", { topic: r, params: i });
      }),
      this.client.on("session_delete", async (r) => {
        await this.cleanup(),
          ...
          this.events.emit(
            "disconnect",
            lc(lo({}, Gt("USER_DISCONNECTED")), { data: r.topic })
          );
      }),
  ...
  onSessionUpdate() {
    Object.keys(this.rpcProviders).forEach((r) => {
      var i;
      this.getProvider(r).updateNamespace(
        (i = this.session) == null ? void 0 : i.namespaces[r]
      );
    });
  }
  setNamespaces(r) {
...
var dI = Object.defineProperty,
  ...
  Hl = (a, r, i) =>
    r in a
      ? dI(a, r, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (a[r] = i),
  Js = (a, r) => {
    for (var i in r || (r = {})) vI.call(r, i) && Hl(a, i, r[i]);
    if (Ul) for (var i of Ul(r)) mI.call(r, i) && Hl(a, i, r[i]);
    return a;
  },
  kl = (a, r) => gI(a, yI(r));
function wo(a) {
...
function wI(a) {
  ...
  return { required: r.length ? _ : void 0, optional: i.length ? A : void 0 };
}
class $c {
  constructor() {
    (this.events = new Or.EventEmitter()),
      ...
      (this.chainId = 1),
      (this.STORAGE_KEY = hI),
      (this.on = (r, i) => (this.events.on(r, i), this)),
      (this.once = (r, i) => (this.events.once(r, i), this)),
      (this.removeListener = (r, i) => (
        this.events.removeListener(r, i), this
      )),
      (this.off = (r, i) => (this.events.off(r, i), this)),
      (this.parseAccount = (r) =>
        this.isCompatibleChainId(r) ? this.parseAccountId(r).address : r),
      (this.signer = {}),
      (this.rpc = {});
  }
  static async init(r) {
  ...
  async connect(r) {
    ...
    try {
        ...
        this.rpc.showQrModal &&
          ...
          await this.signer
            .connect(
              kl(
                Js(
                  { namespaces: Js({}, i && { [this.namespace]: i }) },
      ...
      this.setChainIds(this.rpc.chains.length ? this.rpc.chains : h),
        this.setAccounts(h),
        this.events.emit("connect", { chainId: fc(this.chainId) });
    } catch (o) {
  ...
  registerEventListeners() {
    this.signer.on("session_event", (r) => {
      ...
      this.signer.on("display_uri", (r) => {
        var i, n;
        this.rpc.showQrModal &&
          ((i = this.modal) == null || i.closeModal(),
          (n = this.modal) == null || n.openModal({ uri: r })),
  ...
  parseAccountId(r) {
    const [i, n, o] = r.split(":");
    return { chainId: `${i}:${n}`, address: o };
  }
  setAccounts(r) {
    (this.accounts = r
      .filter(
        (i) =>
          this.parseChainId(this.parseAccountId(i).chainId) === this.chainId
      )
  ...
  async initialize(r) {
    if (
      ((this.rpc = this.getRpcConfig(r)),
      (this.chainId = this.rpc.chains.length
        ? wo(this.rpc.chains)
        : wo(this.rpc.optionalChains)),
      ...
      let i;
      try {
        const { WalletConnectModal: n } = await ew(
          () => import("./index-3I_Tfciy.js").then((o) => o.i),
          __vite__mapDeps([0, 1])
        );
        i = n;
      } catch {
      ...
      if (i)
        try {
          this.modal = new i(
            Js({ projectId: this.rpc.projectId }, this.rpc.qrModalOptions)
          );
        } catch (n) {
          throw (
  ...
  loadConnectOpts(r) {
    ...
    i &&
      ms(i) &&
      ((this.rpc.chains = i.map((h) => this.formatChainId(h))),
      i.forEach((h) => {
  ...
  getRpcUrl(r, i) {
    var n;
    return (
      ((n = this.rpc.rpcMap) == null ? void 0 : n[r]) ||
      `${lI}?chainId=eip155:${r}&projectId=${i || this.rpc.projectId}`
    );
  }
  async loadPersistedSession() {
    if (!this.session) return;
    const r = await this.signer.client.core.storage.getItem(
        `${this.STORAGE_KEY}/chainId`
      ),
      i = this.session.namespaces[`${this.namespace}:${r}`]
        ? this.session.namespaces[`${this.namespace}:${r}`]
        : this.session.namespaces[this.namespace];
    this.setChainIds(
      r ? [this.formatChainId(r)] : i == null ? void 0 : i.accounts
    ),
  ...
  parseAccounts(r) {
    return typeof r == "string" || r instanceof String
      ? [this.parseAccount(r)]
      : r.map((i) => this.parseAccount(i));
  }
}
const LI = $c;
export {
  LI as EthereumProvider,
  pI as OPTIONAL_EVENTS,
  fI as OPTIONAL_METHODS,
  Ec as REQUIRED_EVENTS,
  bc as REQUIRED_METHODS,
  $c as default,
};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = [
      "assetsd/index-3I_Tfciy.js",
      "assetsd/index-CatYzjNY.js",
    ];
  }
